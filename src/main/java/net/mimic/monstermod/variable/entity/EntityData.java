...
public class EntityData implements IEntityData {
    ...
    public void setAnimationState(String state) {
        if (!state.equals(this.animationState)) {
            this.animationState = state;
            markDirty();
        }
    }
    @Override public String getAnimationState() { return animationState; }

    // --- Scale / Flags ---
    @Override public void setScale(float scale) { if (this.scale != scale) { this.scale = scale; markDirty(); } }
    @Override public float getScale() { return scale; }
    @Override public void setFlag(String key, boolean value) { if (flags.getOrDefault(key,false) != value) { flags.put(key,value); markDirty(); } }
    ...
    // --- Scrolls ---
    @Override public void setMainScroll(int value) { mainScroll = value; markDirty(); }
    @Override public int getMainScroll() { return mainScroll; }
    @Override public void alterMainScroll(int delta) { setMainScroll(mainScroll+delta); }
    @Override public void setDGKScroll(int value) { dgkScroll = value; markDirty(); }
    @Override public int getDGKScroll() { return dgkScroll; }
    @Override public void alterDGKScroll(int delta) { setDGKScroll(dgkScroll+delta); }
    ...
    public void deserializeNBT(CompoundTag nbt) {
        animationState = nbt.getString("AnimationState");
    ...
    @Override public boolean isValid() { return owner != null && owner.isAlive(); }
